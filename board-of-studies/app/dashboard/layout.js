  ...
  return (
    <div className="font-space_grotesk">
      ...
      <div className="flex flex-row ml-12 my-6 justify-between w-[34vw]">
        ...
        <Link href={'/profiles'} className="px-12  py-2 rounded-e-md  w-1/2 border-[#bac5d5] border-[1px] cursor-pointer text-center transition-all hover:bg-[#8fa7b4] active:bg-[#709eb7]">Profiles</Link>
      </div>
      {children}
    </div>
