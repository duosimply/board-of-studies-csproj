    ...
    <div className="flex items-center justify-center w-screen h-screen bg-[url('/bluerose.jpg')] bg-cover bg-center">
      ...
      <div className="bg-white  w-[95%] h-[95%] rounded-[45px] grid grid-cols-2">
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="my-6">
            <h2 className="text-4xl font-bold font-bodoni_moda">Welcome Back</h2>
            <p className="text-sm font-space_grotesk">Please enter your email and password to sign in</p>
          </div>
          <form className="space-y-4 w-3/6">
            <div className="my-2 relative">
              <label
                htmlFor="username"
                className="font-space_grotesk text-sm">Email</label>
              <input
                type="text"
                name="username"
                id="username"
            ...
            <div className="my-2 relative">
              <label
                htmlFor="password"
                className="font-space_grotesk text-sm">Password</label>
              <input
              ...
              />
              <div className="absolute top-11 right-4 cursor-pointer" onClick={() => {setPassIsVisible(!passIsVisible)}}>
                {passIsVisible? (
                  <Image
