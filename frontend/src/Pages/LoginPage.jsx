...
const LoginPage = () => {
    return (
        <div className="grid grid-cols-2 w-screen h-screen font-space">
            {/* Left Column */}
                ...
                <form className="space-y-4 w-1/3">
                    <div className="my-2 relative">
                        <input
                            ...
                            id="username"
                            placeholder="Email"
                            className="peer border-[#A69999] border-b-2 p-2 my-2 w-full  focus:outline-none bg-gray-200 placeholder:text-sm placeholder:text-black"
                        />
                        <label
                        htmlFor="username"
                        className=""></label>
